...
import { codeToStatus, ErrorCodeSchema } from "./code";
...
describe("ErrorCodeSchema", () => {
  ...
  it.each(invalidCodes)("$description ('$value') は無効なエラーコード", ({
    value,
  }) => {
...
describe("codeToStatus", () => {
  ...
  it.each(statusMappingTestCases)("$code -> $expectedStatus ($description)", ({
    code,
    expectedStatus,
  }) => {
